...
class AppAgenda( App ):
    ...
    txt_dt = TextInput(size_hint = (0.7, 1.0))
    ...
    def build(self):
        ...
        box_telefone = BoxLayout(orientation="horizontal",
                                size_hint=(1.0, 0.2))
        box_email = BoxLayout(orientation="horizontal", size_hint=(1.0, 0.2))
        box_dt = BoxLayout(orientation="horizontal", size_hint=(1.0, 0.2))
        box_botoes = BoxLayout(orientation="horizontal",size_hint=(1.0,0.2))
        lbl_nome = Label(text="Nome:", 
                        size_hint = (0.3, 1.0))
        lbl_telefone = Label(text="Telefone: ", 
                            size_hint = (0.3, 1.0))
        lbl_email = Label(text="E-mail: ", size_hint = (0.3, 1.0))
        lbl_dt = Label(text="Data de Nascimento (Ex.: dd/mm/aaaa): ", size_hint = (0.3, 1.0))
        ...
        box_dt.add_widget(lbl_dt)
        box_dt.add_widget(self.txt_dt)
